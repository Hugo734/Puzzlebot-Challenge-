...
class SimpleController(Node):
    ...
    def __init__(self):
        ...
        self.vel_sub_ = self.create_subscription(
            TwistStamped, "puzzlebot_controller/cmd_vel", self.velCallback, 10)
        ...
        self.odom_pub_ = self.create_publisher(
            Odometry, "puzzlebot_controller/odom", 10)

        # Speed conversion matrix: [v, w]^T = M * [wr, wl]^T
    ...
    def velCallback(self, msg):
        # Inverse differential kinematics: [v, w] -> [wr, wl]
